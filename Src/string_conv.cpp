...
concept ieee754 = std::is_same_v<_Ty, ieee754_single> || std::is_same_v<_Ty, ieee754_double>;

template <typename _Ty>
using int_fast_t = std::conditional_t<sizeof(_Ty) <= sizeof(int),
  std::conditional_t<std::is_unsigned_v<_Ty>,
    unsigned int,
    int>,
  _Ty>;
